...
| `GET /apartments.html` | Access | Apartment comparison (mobile-first cards) + a map of every apartment with an address (pins resolved from the Bogotá street grid via OSM/Overpass, cached in D1 — no API keys) |
